...
namespace NSM
{
    ...
    /// </summary>
    public sealed partial class Simsons13RuleCalculation : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public Simsons13RuleCalculation()
        {
            ...
            decimal ans = (h/3) * ( (GetDataClass_Calss.ValuesY[0] + GetDataClass_Calss.ValuesY[GetDataClass_Calss.n-1]) + 4*(OddSum) + 2 *(EvenSum));
            ...
            FirstStep.Text = "Ans = " + h + "/3" + " [  ( " + GetDataClass_Calss.ValuesY[0] + " + " + GetDataClass_Calss.ValuesY[GetDataClass_Calss.n - 1]
                           + " ) +" + " 4 * ( " + OddPrint + " )" + Environment.NewLine + "          + 2" + " ( " + EvenPrint + " )  ]" + Environment.NewLine;

           SecondStep.Text = "     = " + h + "/3"  + " [  ( " + (GetDataClass_Calss.ValuesY[0] + GetDataClass_Calss.ValuesY[GetDataClass_Calss.n-1])
                          + " ) +" + " 4 * ( " + OddSum + " ) + 2 * " + " ( " + EvenSum + " )  ]" + Environment.NewLine;

           ThirdStep.Text = "     = " + h + "/3"  + " [  " + (GetDataClass_Calss.ValuesY[0] + GetDataClass_Calss.ValuesY[GetDataClass_Calss.n-1])
                          + " + " + (4 * OddSum) + " + " + (2 * EvenSum) + " ] " + Environment.NewLine;
