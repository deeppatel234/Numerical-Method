...
namespace NSM.Help
{
    ...
    /// </summary>
    public sealed partial class Trap_Help : Page
    {
        ...
        public Trap_Help()
        {
            ...
            if (Help_Class.numerical == "Simpson's 1/3 Method")
            {
                Method.Text = "Simpson's 1/3 Method";
            }
            if (Help_Class.numerical == "Simpson's 3/8 Method")
            {
                Method.Text = "Simpson's 3/8 Method";
            }
            if (Help_Class.numerical == "Trapezoidal Method")
            {
                Method.Text = "Trapezoidal Method";
            }
