...
namespace NSM.Help
{
    ...
    /// </summary>
    public sealed partial class Seidal_Help : Page
    {
        ...
        public Seidal_Help()
        {
            ...
            if (Help_Class.lenear == "Gauss - Seidal Method")
            {
                Method.Text = "Gauss - Seidal Method";
            }
            if (Help_Class.lenear == "Gauss - Jacobi Method")
            {
                Method.Text = "Gauss - Jacobi Method";
            }
