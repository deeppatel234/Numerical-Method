...
namespace NSM.Help
{
    ...
    /// </summary>
    public sealed partial class Finite_Help : Page
    {
        ...
        public Finite_Help()
        {
            ...
            if (Help_Class.finite == "Lagrange Method")
            {
                Method.Text = "Lagrange Method";
            }
            if (Help_Class.finite == "Newton Backward Method")
            {
                Method.Text = "Newton Backward Method";
            }
            if (Help_Class.finite == "Newton Forward Method")
            {
                Method.Text = "Newton Forward Method";
            }
            ...
            if (Settings_Class.themeon == 1)
            {
                ...
                line9.Stroke = new SolidColorBrush(Colors.Black);
                line10.Stroke = new SolidColorBrush(Colors.Black);
                line11.Stroke = new SolidColorBrush(Colors.Black);
