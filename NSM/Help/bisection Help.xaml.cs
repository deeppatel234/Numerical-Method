...
namespace NSM.Help
{
    ...
    /// </summary>
    public sealed partial class bisection_Help : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public bisection_Help()
        {
            ...
            if (Help_Class.nonlenear == "Bisection Method")
            {
                Method.Text = "Bisection Method";
            }
            if (Help_Class.nonlenear == "Secant Method")
            {
                Method.Text = "Secant Method";
            }
            if (Help_Class.nonlenear == "N-R Method")
            {
                Method.Text = "N-R Method";
            }
