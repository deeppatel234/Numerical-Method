...
namespace NSM
{
    ...
    /// </summary>
    public sealed partial class Newton_Backward_Method : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public Newton_Backward_Method()
        {
            ...
            decimal pValue = (Finite_Method_GetData_Class.findx - Finite_Method_GetData_Class.X[Finite_Method_GetData_Class.n-1]) / (Finite_Method_GetData_Class.X[1] - Finite_Method_GetData_Class.X[0]);
            ...
            int tempint = Finite_Method_GetData_Class.n - 2;

            for (int i = 0; i < Finite_Method_GetData_Class.n - 1; i++)
            {
                delta[i] = AlldeltaValues[i, tempint];
                tempint--;
            }
            ...
            ans = Finite_Method_GetData_Class.Y[Finite_Method_GetData_Class.n - 1];
            ...
            for (int i = 0; i < Finite_Method_GetData_Class.n; i++)
            {
                ...
                if (i == 0)
                {
                    DeltaValues[i].Text = " λY0 ^ [" + i + "] = " + Finite_Method_GetData_Class.Y[Finite_Method_GetData_Class.n - 1];
                }
                else
                {
                    DeltaValues[i].Text = " λY0 ^ [" + i + "] = " + delta[i - 1];
                }
            ...
            Pprint.Text = " p  = ( x - x0 ) / h  = " + " ( " + Finite_Method_GetData_Class.findx + " - " + Finite_Method_GetData_Class.X[Finite_Method_GetData_Class.n - 1] + " )  / " + (Finite_Method_GetData_Class.X[1] - Finite_Method_GetData_Class.X[0])
                            + " = " + ((Finite_Method_GetData_Class.findx - Finite_Method_GetData_Class.X[Finite_Method_GetData_Class.n - 1]) / (Finite_Method_GetData_Class.X[1] - Finite_Method_GetData_Class.X[0])) + Environment.NewLine + "   ";
            ...
            Step1.Text = "Ans   = " + Finite_Method_GetData_Class.Y[Finite_Method_GetData_Class.n-1] + step1print + Environment.NewLine + "  ";
            Step2.Text = "      = " + Finite_Method_GetData_Class.Y[Finite_Method_GetData_Class.n - 1] + tempansprint + Environment.NewLine + "  ";
            Step3.Text = "      = " + ans;
