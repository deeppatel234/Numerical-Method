...
namespace NSM
{
    ...
    /// </summary>
    public sealed partial class System_of_NonLinear_Equations : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public System_of_NonLinear_Equations()
        {
        ...
        private void BisectionMethod_click(object sender, RoutedEventArgs e)
        {
            Bisection.Begin();
            BisectionMethod_Class.MethodName = "Bisection Method";
            this.Frame.Navigate(typeof(BisectionMethod));
        }

        private void SecantMethod_click(object sender, RoutedEventArgs e)
        {
            Secant.Begin();
