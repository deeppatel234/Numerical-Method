...
namespace NSM
{
    ...
    /// </summary>
    public sealed partial class GaussSeidal_Calculation : Page
    {
        ...
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
         ...
         public GaussSeidal_Calculation()
        {
            ...
            eq3f.Text = GaussSeidal_class.XThird + "X + " + GaussSeidal_class.YThird + "Y + " + GaussSeidal_class.ZThird + "Z = " + GaussSeidal_class.NThird;
            StackPanalPrint.Children.Add(eq3f);
            StackPanalPrint.Children.Add(blank1);
            ...
            if (GaussSeidal_class.Interations != 0)
            {
                ...
                for (int i = 0; i < GaussSeidal_class.Interations; i++)
                {
                    ...
                    a = i;
                    Tempx = (GaussSeidal_class.NFirst - (GaussSeidal_class.YFirst * y) - (GaussSeidal_class.ZFirst * z));
                    x = Tempx / GaussSeidal_class.XFirst;
                    x = Math.Round(x, GaussSeidal_class.FixDecimal);
                    xprint.Text = " = " + "1 / " + GaussSeidal_class.XFirst + " [ (" + GaussSeidal_class.NFirst + ") - (" + GaussSeidal_class.YFirst + ") * " + y + " - (" + GaussSeidal_class.ZFirst + ") * " + z + "] = " + x;

                    Tempy = (GaussSeidal_class.NSecound - (GaussSeidal_class.XSecound * x) - (GaussSeidal_class.ZSecound * z));
                    y = Tempy / GaussSeidal_class.YSecound;
                    y = Math.Round(y, GaussSeidal_class.FixDecimal);
                    yprint.Text = " = " + "1 / " + GaussSeidal_class.YSecound + " [ (" + GaussSeidal_class.NSecound + ") - (" + GaussSeidal_class.XSecound + ") * " + x + " - (" + GaussSeidal_class.ZSecound + ") * " + z + "] = " + y;

                    Tempz = (GaussSeidal_class.NThird - (GaussSeidal_class.XThird * x) - (GaussSeidal_class.YThird * y));
                    z = Tempz / GaussSeidal_class.ZThird;
                    z = Math.Round(z, GaussSeidal_class.FixDecimal);
                    zprint.Text = " = " + "1 / " + GaussSeidal_class.ZThird + " [ (" + GaussSeidal_class.NThird + ") - (" + GaussSeidal_class.XThird + ") * " + x + " - (" + GaussSeidal_class.YThird + ") * " + y + "] = " + z;
